// pages/pricing.js - Redirects to search since all features are now freeimport { useEffect } from 'react';// pages/pricing.js - Redirects to search since all features are now free// pages/pricing.js// pages/pricing.js
...
export default function PricingPlans() {
  ...
  useEffect(() => {export default function PricingPlans() {import { useRouter } from 'next/router';import React, { useEffect } from 'react';import React, { useEffect } from 'react';

    // Redirect to search since all features are now free

    router.push('/search');  const router = useRouter();
  ...
  return (
    ...
    <div style={{  useEffect(() => {
      ...
      alignItems: 'center',    router.push('/search');import { useRouter } from 'next/router';import { useRouter } from 'next/router';

      justifyContent: 'center',

      minHeight: '50vh',  }, [router]);

      flexDirection: 'column',

      padding: '2rem',export default function PricingPlans() {

      textAlign: 'center',

      background: 'linear-gradient(135deg, #f0fff4 0%, #e6fffa 100%)'  return (

    }}>

      <h1>🎉 All Features Now Free!</h1>    <div style={{  const router = useRouter();import { serverSideTranslations } from 'next-i18next/serverSideTranslations';import { serverSideTranslations } from 'next-i18next/serverSideTranslations';
...
export async function getServerSideProps({ locale }) {      justifyContent: 'center',

  return {

    props: {      minHeight: '100vh',  // Redirect to search since all features are now free
