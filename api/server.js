...
Suspension
Fuel System
Common Issues: List known problem areas that might occur with this vehicle, along with potential cost to fix in USD. Add reference to the number of these issues found.
Mileage: Provide an estimate of the mileage at which these issues typically occur.
AI Analysis: Mention any important recall issues and Write a detailed paragraph analyzing the overall reliability of the vehicle. Mention how it compares to similar cars in its class, note any major concerns, and highlight any particular strengths.Provide supporting sources for your determinations.
...

{
  ...
  "commonIssues":[
  common issues are objects with string values only.refer to the number of reports of this issue found],
  "aiAnalysis": ""
}
...
app.post('/api/fallback-reliability', (req, res) => {
  ...
  // Generate fallback data when ChatGPT API is not available
